...
<p class="has-x-small-font-size"><a href="#" data-type="URL" data-id="#" target="_blank" rel="noreferrer noopener">GitHub</a>&nbsp;·&nbsp;<a href="#" data-type="URL" data-id="#" target="_blank" rel="noreferrer noopener">Twitter</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
